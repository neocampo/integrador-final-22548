...
<html>
    ...
    <body>
        <h1 class="text-center mt-2 text-success">Listado de Socios del Gym</h1>
        
        
        <div class="container">
            <div class="row justify-content-end">   
                <a class=" btn btn-outline-success col-4 ml-0 mt-4 mb-4" href="SociosController?accion=nuevo">Agregar Socio</a>
			 ...
			 <td class="text-center"><a href=<%=rutaE%>><i class="fa-solid fa-xmark"></i> </a></td>
                    </tr>
                    <%
                        }
                    %>
